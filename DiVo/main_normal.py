...
from model.pin_latest import LitPinModule
...
def main():
    ...
    model = LitPinModule([args.windows_size, feature_size], mid_dim, channel_dims, lowrank_order=args.lowrank_order).to(device)
